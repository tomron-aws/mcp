...
"""Tests for the Amazon Q MCP Server."""

import pytest
from awslabs.amazon_q_mcp_server.server import example_tool
from awslabs.amazon_q_mcp_server.server import math_tool

@pytest.mark.asyncio
async def test_example_tool():
    # Arrange
    test_query = "test query"
    expected_project_name = "awslabs Amazon Q MCP Server"
