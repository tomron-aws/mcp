...
from awslabs.kendra_index_mcpserver_mcp_server.server import main
...
class TestMain:
    ...
    @patch('awslabs.kendra_index_mcpserver_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.kendra-index-mcpserver-mcp-server'])
    ...
    @patch('awslabs.kendra_index_mcpserver_mcp_server.server.mcp.run')
    @patch('sys.argv', ['awslabs.kendra-index-mcpserver-mcp-server', '--sse', '--port', '9999'])
    def test_main_sse(self, mock_run):
        ...
        from awslabs.kendra_index_mcpserver_mcp_server.server import mcp
    ...
    def test_module_execution(self):
        ...
        import inspect
        from awslabs.kendra_index_mcpserver_mcp_server import server
